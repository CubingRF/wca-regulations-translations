...
- F2) Команда организаторов может заставить использовать подставки для головоломки, чтобы она не падала до начала попытки. Если подставки применяются, команда организаторов должна объявить об этом до начала раунда.
- F3) Участник может менять положение кнопок во время инспекции. Эти изменения не считаются ходами.
- F4) Участник не должен менять положение циферблатов головоломки во время инспекции. Штраф: дисквалификация попытки (DNF).
