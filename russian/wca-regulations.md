...
- 9f) Результаты раунда измеряются следующим образом:
    - 9f1) Все результаты меньше 10 минут, кроме результатов 3x3x мульти-блайнда, измеряются и округляются вниз до ближайшей сотой секунды (цифры после сотой отбрасываются). Все средние и средние WCA меньше 10 минут округляются до ближайшей сотой секунды.
