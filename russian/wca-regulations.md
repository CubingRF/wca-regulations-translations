...
- 3j) Головоломки должны быть чистыми и не должны иметь никаких пометок, выступающих элементов, повреждений или других различий, которые значительно отличают элементы головоломки от других похожих элементов. Исключение: логотип (см. [Положение 3l](regulations:regulation:3l)).
    - 3j1) Разрешается использовать изношенные в разумной степени головоломки на усмотрение делегата WCA.
        - 3j1a) Износ сдедует считать разумным, если он появился в ходе обычного использования головоломки и не дает значительной дополнительной информации о состоянии головоломки (например, о положении отдельных элементов).
