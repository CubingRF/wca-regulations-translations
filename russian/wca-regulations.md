...
- A1) Попытки в скоростной сборке должны проходить по следующей процедуре:
    - A1a) Команда организаторов должна установить минимум один из следующих видов лимитов по времени для попыток: лимит на каждую попытку и/или суммарный лимит. Лимит должен быть установлен для каждого раунда.
        ...
        - A1a3) Лимиты по времени для всех раундов должны быть объявлены до соревнования. После начала раунда лимиты менять не следует. Изменения могут быть сделаны только на усмотрение делегата WCA, который должен внимательно рассмотреть честность данного изменения.
