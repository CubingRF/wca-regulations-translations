...
- 3h) Модификации, которые совершенствуют основную структуру головоломки, запрещены. Модифицированные версии головоломок разрешены только в том случае, если модификация не даёт дополнительной доступной информации участнику (например, ориентацию или идентификацию элементов головоломки) по сравнению с немодифицированной версией этой головоломки.
    ...
    - 3h5) Падающие кнопки на Clock'е (т. е. кнопки, которые могут переключаться или отклоняться под действием силы тяжести, а не прямого нажатия) не считаются разумным износом, и головоломки с такими кнопками не должны быть допущены.
...
- 9u) Соревнования считаются оконченными, если выполняются все следующие условия:
    ...
    - 9u2) Делегат WCA объявил окончание соревнования. Если делегат WCA не объявил окончание соревнования, любое из следующих событий выполняет функцию такого объявления (то событие, которое произойдет первым):
