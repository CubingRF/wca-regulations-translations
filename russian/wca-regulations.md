...
- C1) Процедура такая же, как и в [Статье A](regulations:article:A) (скоростная сборка). Ниже описаны дополнительные Положения, которые замещают соответствующие Положения в [тСатье A](regulations:article:A).
