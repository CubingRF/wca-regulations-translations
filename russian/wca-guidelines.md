...
- 4g2++) [УТОЧНЕНИЕ] Если Clock падает по время снятия накрывашки, должна быть выдана дополнительная попытка.
- 4g2+++) [РЕКОМЕНДАЦИЯ] Скрамблёру следует оставлять карточку участника вне накрывашки вместо того, чтобы размещать её внутри накрывашки.
