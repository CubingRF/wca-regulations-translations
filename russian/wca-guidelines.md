...
- A4d1+) [УТОЧНЕНИЕ] Если инспекция заняла ровно 15 секунд (т.е. 15.00), должен быть применен штраф: +2 секунды.
- A4d2+) [УТОЧНЕНИЕ] Если инспекция заняла ровно 17 секунд (т.е. 17.00), попытка должна быть дисквалифицирована (DNF).
