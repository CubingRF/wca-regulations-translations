...
- 3d1b+) [УТОЧНЕНИЕ] Узоры могут быть не на каждой стороне, а только на тех, чьи цвета невозможно различить. Элементы не должны иметь никаких особенностей (например, текстуры, неровность шаблона), которые существенно отличают их от других похожих элементов.
