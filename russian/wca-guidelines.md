...
- 12g2+) [НАПОМИНАНИЕ] Раньше за изменение положения кнопок во время инспекции применялся штраф: дисквалификация попытки (DNF). Теперь штраф не применяется.
...
- F1+) [НАПОМИНАНИЕ] Раньше участник должен был ставить головоломку на мат в вертикальном положении. Теперь это не требуется.
