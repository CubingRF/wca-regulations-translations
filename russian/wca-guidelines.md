...
- A1a2++++) [ПРИМЕР] Если раунд имеет суммарный лимит по времени, равный 20 минутам, и лимит на попытку, равный 8 минутам, и результаты первых двух попыток 7:00 и 7:30, то лимит на третью попытку будет равен меньшему значению между 5:30 (вычисляется как 20:00 - 7:00 - 7:30) и 8:00, т. е. 5:30.
