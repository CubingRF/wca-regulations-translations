...
- 4g+) [РЕКОМЕНДАЦИЯ] Для дисциплины Мульти-блайнд, после перемешки всех кубиков скрамблёр должен удостовериться, что среди них нет дубликатов, перемешанных по одному скрамблу.
